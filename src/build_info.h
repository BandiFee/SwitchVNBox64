...
#define BOX64_BUILD_INFO_STRING \
    BOX64_STR ARCH_STR          \
        " v" BOX64_BUILD_INFO_STR(BOX64_MAJOR) "." BOX64_BUILD_INFO_STR(BOX64_MINOR) "." BOX64_BUILD_INFO_STR(BOX64_REVISION) "-" BOX64_CUSTOM_VERSION " " GITREV

#define BOX64_BUILD_INFO_STRING_SHORT \
    BOX64_STR                         \
    " v" BOX64_BUILD_INFO_STR(BOX64_MAJOR) "." BOX64_BUILD_INFO_STR(BOX64_MINOR) "." BOX64_BUILD_INFO_STR(BOX64_REVISION) "-" BOX64_CUSTOM_VERSION
