...
GO("libavutil.so.60", libavutil60)
GO("libavformat.so.62", libavformat62)
GO("libavcodec.so.62", libavcodec62)
GO("libswscale.so.9", libswscale9)
GO("libswresample.so.6", libswresample6)
